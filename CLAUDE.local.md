...
**YOU ARE IN: `tef/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/tef/` (rig root) or other directories
...
**Your mail address:** `tef/polecats/rust`
**Your rig:** tef
**Your Witness:** `tef/witness`
...
| Ask Witness for help | `gt mail send tef/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`tef/witness`) when:
...
```bash
gt mail send tef/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
